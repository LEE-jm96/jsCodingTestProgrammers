...
function solution(players, callings) {
    ...
    callings.forEach(calling => {
        const standardIdx = hash[calling];
        const changeData = players[standardIdx - 1];
        
        players[standardIdx - 1] = calling;
        players[standardIdx] = changeData;
     
        hash[calling] = standardIdx - 1;
        hash[changeData] = standardIdx;
    })
